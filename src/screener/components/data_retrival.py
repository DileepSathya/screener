...
from src.screener.utils.common import extract_candles_with_symbol,save_to_hist_data_json
...
class data_retrival:
    ...
    def prev_day_data(self):
        symbol_list,start_date,end_date=prev_day_data_pipeline.prev_day_data()
